...
for i=1:4
    for j=1:4
        for kk=1:4
            for nn=1:4
                symb4(nn,kk,j,i)=i*1000+j*100+kk*10+nn; 
            end
        end
    end
end
...
for i=1:4
    for j=1:4
        for kk=1:4
            for nn=1:4
                for mm=1:4
                    symb5(mm,nn,kk,j,i)=i*10000+j*1000+kk*100+nn*10+mm; 
                end
            end
        end
    end
...
prob1=[1/2 1/4 1/8 1/8];
pro2=prob1'*prob1;
prob2=reshape(pro2,1,4^2);
for i=1:4
    prob3(i,:)=reshape((prob1'*pro2(i,:)),1,16); 
end
prob3=reshape((prob3),1,4^3);
pro4=prob2'*prob2;
prob4=reshape(pro4,1,4^4);
for i=1:16
    prob5(i,:)=reshape((prob1'*pro4(i,:)),1,64); 
end
